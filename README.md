...
THE MEMORY ADRESS POINTERS and OFFSETS are for the driver version 15.4.1.354 (updayed to driver version 5.5.1.390 on 08.01.2022) .. its probably wont work on other driver versions, but its easy to find the pointers and offsets with cheat engine 
